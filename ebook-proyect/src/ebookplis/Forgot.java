...
public class Forgot extends JFrame implements ActionListener{
	...
	JLabel l3 = new JLabel("tu pregunta ");
	l3.setFont(new Font("Tahoma", Font.BOLD, 13));
	l3.setBounds(109, 154, 156, 27);
	contentPane.add(l3);
        
        JLabel l31 = new JLabel(" de seguridad:");
	l31.setFont(new Font("Tahoma", Font.BOLD, 13));
	l31.setBounds(109, 170, 156, 27);
	contentPane.add(l31);

	JLabel l4 = new JLabel("respuesta");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(41, 41, 41), 2), "Forgot-Panel",
