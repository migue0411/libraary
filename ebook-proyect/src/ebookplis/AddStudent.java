...
public class AddStudent extends JFrame implements ActionListener{
    ...
    public AddStudent() {
        super("añadir estudiante");
	setBounds(370, 200, 450, 470);
	contentPane = new JPanel();
	contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
	setContentPane(contentPane);
	contentPane.setLayout(null);

	JLabel l1 = new JLabel("estudiante_id");
	...
	JLabel l3 = new JLabel("nombre del");
	l3.setForeground(new Color(41, 41, 41));
	l3.setFont(new Font("Tahoma", Font.BOLD, 14));
	l3.setBounds(64, 130, 102, 22);
	contentPane.add(l3);
        
        JLabel l31 = new JLabel(" padre");
	l31.setForeground(new Color(41, 41, 41));
	l31.setFont(new Font("Tahoma", Font.BOLD, 14));
	l31.setBounds(64, 145, 102, 22);
	contentPane.add(l31);

	JLabel l4 = new JLabel("programa");
	l4.setForeground(new Color(41, 41, 41));
	l4.setFont(new Font("Tahoma", Font.BOLD, 14));
	l4.setBounds(64, 173, 102, 22);
	contentPane.add(l4);

        JLabel l5 = new JLabel("año");
	...
	comboBox.setBounds(176, 176, 154, 20);
	contentPane.add(comboBox);

	comboBox_1 = new JComboBox();
	comboBox_1.setModel(new DefaultComboBoxModel(new String[] { "PRIMERO", "SEGUNDO", "TERCERO", "CUARTO" }));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(41, 41, 41), 2, true), "Add-Student",
			TitledBorder.LEADING, TitledBorder.TOP, null, new Color(41, 41, 41)));
	panel.setBackground(new Color(211, 211, 211));
	panel.setBounds(10, 34, 358, 348);
