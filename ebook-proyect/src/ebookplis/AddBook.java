...
public class AddBook extends JFrame implements ActionListener{
	...
	l7.setForeground(new Color(41, 41, 41));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(41, 41, 41), 2), "Add Books", TitledBorder.LEADING,
