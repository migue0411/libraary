...
public class Signup extends JFrame implements ActionListener{
	...
	JLabel lblAnswer = new JLabel("responder :");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(41, 41, 41), 2), "crear-cuenta",
