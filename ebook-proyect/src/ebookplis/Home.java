...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(41, 41, 41), new Color(128, 128, 128)));
            ...
            JLabel l1 = new JLabel("EBOOKPLIS");
            l1.setForeground(Color.WHITE);
            l1.setFont(new Font("Comics Sans ms ", Font.BOLD, 50));
            l1.setBounds(268, 30, 701, 80);
            contentPane.add(l1);

            JLabel l2 = new JLabel("");
            l2.setVerticalAlignment(SwingConstants.TOP);
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("ebookplis/icons/second.png"));
            ...
            ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("ebookplis/icons/third.png"));
            ...
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("ebookplis/icons/fourth.png"));
            ...
            b3 = new JButton("AÑADIR ESTUDIANTE");
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(41, 41, 41), 2), "Operation", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(41, 41, 41)));
            panel.setBounds(20, 120, 750, 260);
            panel.setBackground(Color.WHITE);
            contentPane.add(panel);

            b4 = new JButton("LIBROS EN EDICION");
            ...
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("ebookplis/icons/fifth.png"));
            ...
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("ebookplis/icons/sixth.png"));
            ...
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("ebookplis/icons/seventh.png"));
            ...
            panel2.setBorder(new TitledBorder(new LineBorder(new Color(41, 41, 41), 2), "Action", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(41, 41, 41)));
